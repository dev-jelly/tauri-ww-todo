    ...
    <div class="flex relative items-center pl-3 cursor-pointer">
        ...
        if (e.key === "Enter") {
          ...
          editMode = false;
               ...
               class="ml-2 h-11 text-gray-200 bg-gray-100 rounded border-gray-900 focus:ring-2 p-2 dark:bg-gray-600 dark:border-gray-900 w-full pr-14"/>
        ...
        <button
                ...
                class="text-black dark:text-white absolute right-3 top-2 bottom-2 bg-none hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-md text-2xl px-3 leading-5 pb-1 dark:bg-gray-700 dark:hover:bg-gray-800 dark:focus:ring-gray-800">
            -
        </button>
    </div>
</div>

...
<li class="w-full rounded-t-lg border-b border-gray-200 dark:border-gray-600 hover:curs or-pointer"
  ...
  <div class="flex relative items-center pl-3">
    ...
    <label for="todo-checkbox-{id}" class="py-3 ml-2 w-full text-md font-medium text-gray-900 dark:text-gray-300 "
           class:line-through={done} class:text-gray-500={done}>{todo}</label>
    <button
